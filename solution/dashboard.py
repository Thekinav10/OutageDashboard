...
def _line_chart(series: list[dict]) -> str:
    ...
    return f"<svg class='chart' viewBox='0 0 760 210' role='img' aria-label='Average latency trend with detection threshold'><line class='grid-line' x1='42' y1='22' x2='742' y2='22'/><line class='grid-line' x1='42' y1='102' x2='742' y2='102'/><line class='grid-line' x1='42' y1='182' x2='742' y2='182'/><line class='threshold' x1='42' y1='{threshold:.1f}' x2='742' y2='{threshold:.1f}'/><line class='marker' x1='{incident_x:.1f}' y1='22' x2='{incident_x:.1f}' y2='182'/><text x='5' y='26'>{high:.0f}ms</text><text x='5' y='186'>{low:.0f}ms</text><text x='48' y='{threshold - 5:.1f}'>detection threshold</text><polygon class='area' points='{area}'/><polyline class='line' points='{' '.join(points)}'/><circle class='end-dot' cx='{end[0]}' cy='{end[1]}' r='5'/><text x='{incident_x + 6:.1f}' y='34'>first signal</text><text x='42' y='204'>window start</text><text x='680' y='204'>now</text></svg>"
...
<section class='layout' id='signals'><article class='panel'><div class='panel-head'><div><div class='eyebrow'>Signal telemetry</div><h2>Latency drift across platform</h2><div class='panel-sub'>Detection threshold and first-signal marker / {window}</div></div><div class='chart-legend'><span>latency</span><span>current</span></div></div>{_line_chart(result.get('latency_series', []))}</article><article class='panel'><div class='panel-head'><div><div class='eyebrow'>Signal attribution</div><h2>Risk mix</h2><div class='panel-sub'>Total anomaly observations by service</div></div></div><div class='pie-layout'>{pie}{legend}</div></article></section>
